...
import { Eye, Pencil, Trash2, Globe2, Archive } from "lucide-react";
...
type NewsCardProps = {
  ...
  onUnpublish: (post: NewsPost) => void;
};

export function NewsCard({ post, onEdit, onDelete, onPreview, onPublish, onUnpublish }: NewsCardProps) {
  return (
    <Card>
      <CardHeader>
